  ...
  const submit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (mode === 'reset') {
        ...
        setSuccess("If an account exists for this email, we've sent a password reset link. Check your inbox.")
        return
      }
  ...
  return (
    <main className="authPage">
      <div className="authCard">
        ...
        <h1>
          {mode === 'login' ? 'Welcome back.' : mode === 'signup' ? 'Create your ReachOut account.' : 'Reset your password.'}
        </h1>
        ...
        >
          {mode === 'signup' ? 'Already have an account? Sign in' : mode === 'reset' ? 'Back to sign in' : 'New to ReachOut? Create your account'}
        </button>
